    ...
    <section className='about'>
      ...
      <div className='about__info'>
        ...
        <p className='about__text'>
          Меня зовут Ольга Альбукова и этот сайт - моя дипломная работа по профессии Веб-разработчик на Веб-факультете
          Яндекс.Практикум.
        </p>
        <p className='about__text'>
        ...
        <ul className="about__description">
          <li className='about__description-item'>
            Кроссбраузерную и adaptive/responsive верстку (HTML, CSS) интернет приложений по методологии БЭМ.
          </li>
          <li className='about__description-item'>
            Современные возможности языка JavaScript для программирования интерфейса пользователя и динамики сайта в
          ...
          <li className='about__description-item'>
            Различные инструменты для разработки и отладки ПО (WebStorm, VSCode, Git, Figma, Avacode, dev tools, Postman).
          </li>
          <li className='about__description-item'>
